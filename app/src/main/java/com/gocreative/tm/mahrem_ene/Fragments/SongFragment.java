...
import com.gocreative.tm.mahrem_ene.PickCityActivity;
...
public class SongFragment extends Fragment {
    ...
    private void eventChangeListener() {
        ...
        musicArrayList.add(new Music("Mekdebim jana jan", "Halk doredijiligi"));
        musicAdapter.notifyDataSetChanged();
        jcAudios.add(JcAudio.createFromRaw(getResources().getIdentifier("music_3", "raw", getActivity().getPackageName())));
