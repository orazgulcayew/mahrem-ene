...
import com.gocreative.tm.mahrem_ene.Adapters.HospitalsAdapter;
...
public class PickHospitalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hospitalsAdapter = new HospitalsAdapter(PickHospitalActivity.this, hospitalArrayList, position, address, city);
