...
import com.gocreative.tm.lukman.Adapters.CitiesAdapter;
import com.gocreative.tm.lukman.Models.City;
...
public class PickCityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        citiesAdapter = new CitiesAdapter(PickCityActivity.this, cityArrayList, position, _name);
